...
import com.nocountry.equitrust.service.impl.AuthService;
...
public class AuthController {
    ...
    @GetMapping("/test")
    @Operation(summary = "Test endpoint to verify authentication is working")
    public ResponseEntity<String> test() {
        return ResponseEntity.ok("Authentication system is working!");
    }
}